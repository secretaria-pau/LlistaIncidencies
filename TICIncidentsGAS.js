const SHEET_ID = "16zyQneOwbnWXj8h42CP-ABv75UCkYQOLIATiugFu9Aw";
const SHEET_NAME = "Incidències TIC";
...
function setupSheet() {
  ...
  if (sheet.getLastRow() === 0) {
    const headers = [
      "ID", "Tipus", "Qui fa la incidencia?", "Espai", "Dispositiu afectat", 
...
function updateIncident(data) {
  ...
  sheet.getRange(rowIndex, 5).setValue(data["Dispositiu afectat"]);
